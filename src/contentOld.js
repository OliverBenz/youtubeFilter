...
function checkCurrentVideoAllowed(allowedChannels) {
    ...
    if (!allowedChannels.includes(videoChannelName)) {
        ...
        if (videoPlayer) {
            ...
            console.log("Youtube Filter: Blocking video from '" + videoChannelName + "'");
        }
    }
}
...
chrome.storage.sync.get(['allowedChannels', 'isExtensionEnabled'], (data) => {
    ...
    if (isExtensionEnabled) {
        ...
        checkCurrentVideoAllowed(allowedChannels);
    } else {
